...
class TestSquare_size(unittest.TestCase):
    """Unit tests for `size` initialization of the `Square` class"""
...
class TestSquare_x(unittest.TestCase):
    """Unit tests for initialization of `Square` `x` attribute"""
...
class TestSquare_y(unittest.TestCase):
    """Unit tests for initialization of `Square` `y` attribute"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unit tests for order of `Square` attribute initialization"""
...
class TestSquare_area(unittest.TestCase):
    """Unit tests for `area` method of the `Square` class"""
...
class TestSquare_stdout(unittest.TestCase):
    """Unit tests for `__str__` and `display` methods of `Square` class"""
...
class TestSquare_update_args(unittest.TestCase):
    """Unit tests for `update` (args) method of the `Square` class"""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unit tests for `update` (kwargs) method of `Square` class"""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unit tests for `to_dictionary` method of the `Square` class"""
